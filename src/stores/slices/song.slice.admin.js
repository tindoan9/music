...
const songSlice = createSlice({
  ...
  reducers: {
    ...
    deleteSongActionSuccess: (state, action) => {
      ...
      const newData = state.songState.data.filter(
...
export const {
  postSongAction,
  postSongActionSuccess,
  postSongActionFailed,
  fetchSongAction,
  fetchSongActionfailed,
  fetchSongActionSuccess,
  deleteSongAction,
  deleteSongActionSuccess,
  deleteSongActionFailed,
  editSongAction,
  editSongActionSuccess,
  editSongActionFailed,
  playSongAction,
} = songSlice.actions;
